...
export const CARD_RULES = {
  ...
  Q: {
    ...
    icon: '👑',
    type: 'rule',
    description: 'Drawer becomes Question Master. If the other player answers ANY question directly (not with a question), they drink 3 sips. Lasts until next Queen.',
    drawerSips: 0,
    otherSips: 0,
    interaction: 'question_master',
  },
  K: {
